...
const images = Array.from({ length: 30 }, (_, i) => `/images/gallery (${i + 1}).jpg`);
...
const Gallery = () => {
  ...
  return (
    <main className="bg-[var(--primary)] text-white flex flex-col">
      ...
      {/* Masonry Grid */}
      <div className="relative z-10 -mt-10 px-4 sm:px-10 md:px-20 py-20 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 auto-rows-[5px]">
        {images.map((img, idx) => {
